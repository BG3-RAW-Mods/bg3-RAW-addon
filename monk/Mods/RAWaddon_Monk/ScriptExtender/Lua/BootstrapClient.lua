local function monkChanges()
    ...
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Monk_Shadow_3, "80e8c4ce-1df6-4987-bc69-8f7fc2e5b031", {}))
    -- Open Hand doesn't have Manifestation ability (this is actually an OP variant of Manifest Blow)
    Mods.SubclassCompatibilityFramework.Api.RemoveStrings(Mods.RAWaddon.removeString(Mods.RAWaddon.RAW_Monk_OpenHand_6, "PassivesAdded", { "Manifestation_of_Body", "Manifestation_of_Mind", "Manifestation_of_Soul" }))
    ...
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addSelectSpells(Mods.RAWaddon.RAW_Monk_FourElements_3, "50072bc3-d182-4ea6-9f7a-0eb021ce6c86", 2, { SelectorId = "FourElements"}))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_4, "SelectSpells", "9da8ef4f-676b-46f1-81e4-f7c3cfd1c34c"))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_5, "SelectSpells", "9da8ef4f-676b-46f1-81e4-f7c3cfd1c34c"))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_6, "SelectSpells", "c841dfad-9d3b-486d-ad6b-ac3eaebc2db4"))  
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addSelectSpells(Mods.RAWaddon.RAW_Monk_FourElements_6, "65897e6b-7863-4a0c-9c99-753a793df498", 1, { SelectorId = "FourElements", SwapAmount = 1 }))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_7, "SelectSpells", "c841dfad-9d3b-486d-ad6b-ac3eaebc2db4"))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_8, "SelectSpells", "c841dfad-9d3b-486d-ad6b-ac3eaebc2db4"))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_9, "SelectSpells", "c841dfad-9d3b-486d-ad6b-ac3eaebc2db4"))  
    Mods.SubclassCompatibilityFramework.Api.RemovePassives(Mods.RAWaddon.removeString(Mods.RAWaddon.RAW_Monk_FourElements_9, "PassivesAdded", { "ImprovedElementalCasting" }))
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_10, "SelectSpells", "c841dfad-9d3b-486d-ad6b-ac3eaebc2db4"))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_11, "SelectSpells", "cf014f77-4d0a-4322-a2bf-95e38b89435b"))  
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addSelectSpells(Mods.RAWaddon.RAW_Monk_FourElements_11, "a279acb9-88f8-4246-83c6-146d8fc77c8a", 1, { SelectorId = "FourElements", SwapAmount = 1 }))  
    Mods.SubclassCompatibilityFramework.Api.RemoveSelectors(Mods.RAWaddon.removeSelector(Mods.RAWaddon.RAW_Monk_FourElements_12, "SelectSpells", "cf014f77-4d0a-4322-a2bf-95e38b89435b"))  
end
