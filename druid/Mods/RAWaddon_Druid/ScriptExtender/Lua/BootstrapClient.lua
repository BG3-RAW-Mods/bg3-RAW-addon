local function druidChanges()
    ...
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Druid_Moon_2, "eab46c7c-c5f2-4534-a0f1-71dffaa6fc8e", {}))    
    ...
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Druid_Moon_12, "cfdf8d6b-2fca-4992-af0e-e4a4ee318060", {}))    
    -- Flying Wild Shapes
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Druid_Land_8, "fb4db188-e2ed-467b-a8f5-ec6a3fe47dca", {}))    
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Druid_Spore_8, "fb4db188-e2ed-467b-a8f5-ec6a3fe47dca", {}))    
    Mods.SubclassCompatibilityFramework.Api.InsertSelectors(Mods.RAWaddon.addAddSpells(Mods.RAWaddon.RAW_Druid_Moon_8, "fb4db188-e2ed-467b-a8f5-ec6a3fe47dca", {}))    
